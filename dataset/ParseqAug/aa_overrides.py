...
from timm.data.auto_augment import _randomly_negate, LEVEL_TO_ARG, NAME_TO_OP, rotate
...
def _level_to_arg(level, hparams, key, default):
    ...
    try: # To be comparable with different timm version
        level = (level / auto_augment._MAX_LEVEL) * magnitude
    except:
        level = (level / auto_augment._LEVEL_DENOM) * magnitude
